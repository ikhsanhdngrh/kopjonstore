...
$code = new Code();
$data_baju_keluar = $code->show();

if (isset($_POST['baju_klr_add_btn'])) {
    $idb = $_POST['nmbaju'];//id baju
    $tgl = $_POST['tanggal'];
    $jumlah = $_POST['jumlah'];
    $ket = $_POST['keterangan'];

    $add_status = $code->baju_klr($idb, $tgl, $jumlah, $ket);
    if ($add_status) {
        header('Location: baju_klr_read.php');
    };
};
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Tambah Data Keluar Stock Baju</title>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            ...
                            <div class="mb-3">
                                <button type="submit" name="baju_klr_add_btn" class="btn btn-primary">Simpan</button>
                            </div>
                        </form>
                    </div>
